...
# Benchmark script for gemm_fp_32_cudaDMA_v2 across all dataset sizes
# Builds each dataset size, runs 5 times, and computes average GPU time
# Usage: ./benchmark_cudadma_v2.sh [max_dimension]
# Example: ./benchmark_cudadma_v2.sh 1024  (runs benchmarks up to 1024x1024)
...
ITERATIONS=5
MAKEFILE="Makefile_dma_v2"
EXECUTABLE="gemm_fp_32_cudadma_v2"

# Create timestamped log file
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
LOGFILE="benchmark_v2_results_${TIMESTAMP}.txt"
...
log_print "========================================"
log_print "cudaDMAv2 GEMM Benchmark Suite"
log_print "========================================"
log_print "Date: $(date)"
...
for i in "${!DATASETS[@]}"; do
    ...
    for run in $(seq 1 $ITERATIONS); do
        ...
        # Parse CPU time (may be N/A for large datasets)
