...
__forceinline__ __device__ void readTileBatched(const unsigned int N, double* src, double* dest) {
...
/// @param N Row stride of src
template<unsigned int BM, unsigned int BN, unsigned int NUM_THREADS>
__forceinline__ __device__ void readTileChunked(const unsigned int N, double* src, double* dest) {
